            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {coreFeatures.map(({ icon: Icon, title, description }, index) => (
                <motion.div
                  ...
                  className="p-8 bg-white/20 backdrop-blur-xl border border-white/30 rounded-2xl relative transition-all duration-300 hover:-translate-y-2 hover:shadow-xl flex flex-col"
                >
